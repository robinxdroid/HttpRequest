...
import static net.robinx.lib.http.network.ex.hurl.RequestBodyConstants.HEADER_USER_AGENT;
...
import net.robinx.lib.http.network.HTTPSTrustManager;
...
public class HurlStack implements HttpStack {
	...
	public HttpResponse performRequest(Request<?> request, Map<String, String> additionalHeaders) throws IOException {
		CLog.w("Current Stack:%s","HTTP_URL_CONNECTION");
