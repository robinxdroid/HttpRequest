package net.robinx.lib.http.dispatcher;
import java.util.Timer;
import java.util.TimerTask;
import java.util.concurrent.BlockingQueue;

import net.robinx.lib.http.RequestContext;
...
import net.robinx.lib.http.utils.NetworkUtils;
        ...
        while (true) {
            ...
            try {
               CLog.d("network-queue-take");
                ...
                if (request.getRequestCacheOptions().isUseCacheDataWhenTimeout()) {
                	...
                	if (cacheData != null) {
                    	new Timer().schedule(new TimerTask() {
          				...
          				}, request.getRequestCacheOptions().getTimeController().getTimeout());
					}
